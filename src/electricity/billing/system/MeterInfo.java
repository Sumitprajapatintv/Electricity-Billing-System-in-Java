...
public class MeterInfo extends JFrame implements ActionListener{
    ...
    MeterInfo(String meternumber) {
        ...
        JLabel lblmeterno = new JLabel("Connection Type");
        lblmeterno.setBounds(100, 120, 100, 20);
        p.add(lblmeterno);
        
        meterlocation = new Choice();
        meterlocation.add("Domestic/Commercial");
        meterlocation.add("Industrial");
        meterlocation.add("Agriculture");
        meterlocation.setBounds(240, 120, 200, 20);
        p.add(meterlocation);
        
        JLabel lbladdress = new JLabel("Select Board");
        lbladdress.setBounds(100, 160, 100, 20);
        p.add(lbladdress);
        
        metertype = new Choice();
        metertype.add("Gujarat Urja Vikas Nigam Ltd(GUVNL)");
        metertype.add("Gujarat State Electricity Corporation Limited (GSECL)");
        metertype.add("Dakshin Gujarat Vij Company Limited (DGVCL)");
        metertype.add("UGVCL GANDHINAGAR");
        ...
        JLabel lblstate = new JLabel("Meter Type");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Request Recoded and Your Reference No is \n '"+meter+"'");
                setVisible(false);
