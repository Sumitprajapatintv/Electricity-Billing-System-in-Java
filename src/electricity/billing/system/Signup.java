...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup()
    {
        ...
        JLabel lblmeter=new JLabel("Account No");
        ...
        panel.add(meter);
         ...
         meter.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent fe) {
                try {
                    Conn c  = new Conn();
                    ResultSet rs = c.s.executeQuery("select * from login where Account_no = '"+meter.getText()+"'");
                    while(rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==create)
        {
             ...
             try
             {
                String encryptedval = SHA256.toHexString(getSHA(spassword));
               ...
               String query = null;
                if (atype.equals("Admin")) {
                    query = "insert into login values('"+smeter+"', '"+susername+"', '"+sname+"', '"+encryptedval+"', '"+atype+"')";
                } else {
                    query = "update login set password = '"+encryptedval+"', user = '"+atype+"' where Account_no = '"+smeter+"'";
                }
