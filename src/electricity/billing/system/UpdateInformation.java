...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter) {
        ...
        JLabel lblmeternumber = new JLabel("Account No");
        ...
        try {
            ...
            while(rs.next()) {
                ...
                meternumber.setText(rs.getString("Account_No"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//
    UpdateInformation(JTextField Accountn) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                Conn c = new Conn();
                c.s.executeUpdate("update customer set adress = '"+address+"', city = '"+city+"', state = '"+state+"', email = '"+email+"', phone = '"+phone+"' where meter_no = '"+meter+"'");
