...
public class GenerateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            rs = c.s.executeQuery("select * from bill where Account_No = '"+meter+"' and month='"+month+"'");
          ...
          String Mr="";
            if(rs.next()) {
                ...
                area.append("\n-------------------------------------------------------");
                area.append("\n    Total Payable Of Current Month: " + rs.getString("totalbill"));
                Mr=rs.getString("totalbill");
                area.append("\n");
            }
             ...
             if(rs.next()) {
                ...
                area.append("\n-------------------------------------------------------");
                area.append("\n    Total Payable: " + rs.getString("Outstanding"));
                area.append("\n");
            }
